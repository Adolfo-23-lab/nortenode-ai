    ...
    <section className="py-24 relative px-4 md:px-6 max-w-6xl mx-auto" id="pricing">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="glass rounded-3xl p-8 border border-white/10 hover:border-emerald-500/50 transition-colors relative flex flex-col">
          <h3 className="text-2xl font-bold text-white mb-2">Web Premium + Bot IA</h3>
          <p className="text-slate-400 mb-6">Setup único. Ideal para clínicas que necessitam renovar a sua imagem digital completa.</p>
          <div className="text-4xl font-extrabold text-white mb-8">
            <span className="text-lg text-slate-500 font-normal mr-1">Desde</span>
            €990
          </div>
          ...
          <button className="w-full py-4 rounded-full bg-white/10 hover:bg-white/20 text-white font-semibold transition-all">
            Consultar Projeto
          </button>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-600/20 to-emerald-900/20 border border-emerald-500/30 rounded-3xl p-8 relative flex flex-col transform md:-translate-y-4 shadow-2xl shadow-emerald-500/10">
          ...
          <p className="text-slate-400 mb-6">Subscrição mensal. Nós gerimos o seu bot e servidores.</p>
          <div className="text-4xl font-extrabold text-white mb-8">
            €97<span className="text-lg text-slate-500 font-normal">/mês</span>
          </div>
          ...
          <button className="w-full py-4 rounded-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold transition-all hover:scale-105 shadow-lg shadow-emerald-500/25">
